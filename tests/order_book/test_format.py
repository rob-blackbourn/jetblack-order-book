...
def test_format():
    ...
    order_book.add_order(Side.BUY, Decimal('10.1'), 5, Style.LIMIT)
    order_book.add_order(Side.BUY, Decimal('10.2'), 5, Style.LIMIT)
    order_book.add_order(Side.BUY, Decimal('10.3'), 5, Style.LIMIT)

    order_book.add_order(Side.SELL, Decimal('11.1'), 5, Style.LIMIT)
    order_book.add_order(Side.SELL, Decimal('11.2'), 5, Style.LIMIT)
